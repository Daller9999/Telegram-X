...
public class StickerSmallView extends View implements FactorAnimator.Target, Destroyable {
    ...
    public interface StickerPressEvent {
        void onClick();
    }

    public StickerPressEvent stickerPressEvent;

    public void setStickerPressEvent(StickerPressEvent stickerPressEvent) {
        this.stickerPressEvent = stickerPressEvent;
    }
    ...
    public boolean onTouchEvent (MotionEvent e) {
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (stickerPressEvent != null) {
                    stickerPressEvent.onClick();
                }
                return true;
            }
