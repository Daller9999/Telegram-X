...
public class Tdlib implements TdlibProvider, Settings.SettingsChangeListener {
    ...
    int connectionState = STATE_UNKNOWN;
  ...
  /*public void toggleDebug (boolean isDebug) {
    ...
    public @Nullable
    Generation generateFile(String id, TdApi.FileType fileType, boolean isSecret, int priority, long timeoutMs) {
    ...
    public @Nullable
    TdApi.File getRemoteFile(String remoteId, TdApi.FileType fileType, long timeoutMs) {
    ...
    public @NonNull
    TdApi.Chat chatStrict(long chatId) {
        final TdApi.Chat chat;
        synchronized (dataLock) {
            chat = chats.get(chatId);
            if (chat == null) {
    ...
    public @Nullable
    TdApi.Chat syncChat(@NonNull TdApi.Chat chat) {
        return knownChatIds.contains(chat.id) ? chat : chatSync(chat.id);
    }

    public @Nullable
    TdApi.Chat chatSync(long chatId) {
        return chatSync(chatId, TimeUnit.SECONDS.toMillis(5));
    }

    public @Nullable
    TdApi.Chat chatSync(long chatId, long timeoutMs) {
        if (chatId == 0)
            return null;
    ...
    public @NonNull
    TdlibChatList chatList(@NonNull TdApi.ChatList chatList) {
        synchronized (dataLock) {
    ...
    private @NonNull
    TdlibChatList chatListImpl(@NonNull TdApi.ChatList chatList) {
        final String key = TD.makeChatListKey(chatList);
    ...
    private @Nullable
    TdlibChatList[] chatListsImpl(@Nullable TdApi.ChatPosition[] positions) {
    ...
    public @NonNull
    List<TdApi.Chat> chats(long[] chatIds) {
    ...
    public @NonNull
    List<TdApi.User> chatUsers(long[] chatIds) {
    ...
    public @Nullable
    TdApi.ChatMemberStatus chatStatus(long chatId) {
        if (chatId == 0) {
            return null;
        }
        switch (ChatId.getType(chatId)) {
    ...
    public @Nullable
    TdApi.ChatType chatType(long chatId) {
        if (chatId == 0) {
            return null;
        }
        switch (ChatId.getType(chatId)) {
    ...
    public @Nullable
    TdApi.ChatNotificationSettings chatSettings(long chatId) {
        TdApi.Chat chat = chat(chatId);
        return chat != null ? chat.notificationSettings : null;
    }

    public @Nullable
    TdApi.ChatPermissions chatPermissions(long chatId) {
        TdApi.Chat chat = chat(chatId);
    ...
    public @Nullable
    TdApi.User chatUser(TdApi.Chat chat) {
    ...
    public @Nullable
    TdApi.User chatUser(long chatId) {
        long userId = chatUserId(chatId);
        if (userId != 0) {
    ...
    public @NonNull
    List<Long> getPinnedChats(final @Nullable TdApi.ChatList chatList) {
        synchronized (dataLock) {
    ...
    public @Nullable
    String messageUsername(TdApi.Message msg) {
        if (msg != null) {
  ...
  /*public boolean updateCustomLanguageCode (String languageCode) {
    ...
    public @Nullable
    String suggestedLanguagePackId() {
        return suggestedLanguagePackId;
    }

    public @Nullable
    TdApi.LanguagePackInfo suggestedLanguagePackInfo() {
    ...
    public @Nullable
    ChatPasscode chatPasscode(TdApi.Chat chat) {
        if (chat == null) {
            return null;
        }
  ...
  public void setDisablePinnedMessageNotifications (boolean disable) {
    ...
    @AnyThread
    public @Nullable
    TdApi.ChatTheme chatTheme(String themeName) {
        synchronized (dataLock) {
